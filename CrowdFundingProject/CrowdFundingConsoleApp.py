...
def getInfoForRegistration():
    ...
    email = validateEmail(1)
    password = validatePassword()
    confirmPassword = input("Enter password agne :")
    while True:
...
def validatePassword():
    ...
    while True:
        if fullmatch(regex, password):
            ...
            password = input("Invalid password: try enter password agen, should be content the spatial character and number  : ")
    return password
...
def validatePhone():
    ...
    while True:
        if fullmatch(regex, phonenumber):
            ...
            phonenumber = input("Invalid phonenumber: try enter agen, the phonenumber should be like this (01016529554) : ")
    return phonenumber
